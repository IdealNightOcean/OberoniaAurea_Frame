...
{
    public static bool TryGenerateQuestAndMakeAvailable(out Quest quest, QuestScriptDef scriptDef, float points, bool forced = false, bool sendAvailableLetter = true)
    {
        Slate slate = new();
    ...
    public static bool TryGenerateQuestAndMakeAvailable(out Quest quest, QuestScriptDef scriptDef, Slate slate, bool forced = false, bool sendAvailableLetter = true)
    {
        ...
        try
        {
            if (forced || scriptDef.CanRun(slate))
            {
